      ...
      <div className="relative" ref={ref}>
        ...
        >
          ...
          {!compact && (
            <>
              <span
                className={`hidden md:block text-sm font-medium max-w-[90px] truncate ${isLight ? "text-gray-800" : "text-white"}`}
              >
                {displayName}
              </span>
              <ChevronDown
                size={13}
                className={`hidden md:block transition-transform ${isOpen ? "rotate-180" : ""} ${isLight ? "text-gray-500" : "text-gray-400"}`}
              />
            </>
          )}
        </button>
          ...
          {isOpen && (
            ...
            >
              ...
              <div className="py-1">
                ...
                >
                  <User size={15} className="text-gray-400 shrink-0" /> My
                  Profile
                </Link>
                {!isSeller && (
                  <Link
                    ...
                    className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-[#F5F5F5] transition"
                  >
                    <Package size={15} className="text-gray-400 shrink-0" /> My
                    Orders
                  </Link>
                )}
                ...
                {isStoreOwner && (
                  <Link
                    ...
                    className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-[#F5F5F5] transition"
                  >
                    <Store size={15} className="text-gray-400 shrink-0" /> My
                    Store
                  </Link>
                )}
                {isSeller && (
