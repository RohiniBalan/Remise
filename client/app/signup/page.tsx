...
function CustomerSignupPageContent() {
  ...
  // Already logged in → redirect straight to dashboard / home
  useEffect(() => {
  ...
  const handleGoogleSignup = () => {
    window.location.href = `${API_URL}/auth/google?role=customer`;
  };
      ...
      >
        ...
        <div className="mb-5 text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Join Remise for a seamless shopping experience
          </p>
        </div>
        ...
        {/* <div className="mt-5 border-t border-white/10 pt-4 text-center">
          ...
          >
            ...
            <span>Want to sell on Remise?</span>
