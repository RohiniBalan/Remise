        ...
        <div className="max-w-7xl mx-auto mb-12">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-12">
            <div className="space-y-4 w-full lg:w-auto">
              <div className="relative">
                <h1 className="text-4xl sm:text-5xl md:text-7xl font-black uppercase tracking-tighter mb-2 relative leading-tight">
                  <span className="relative z-10 block sm:inline">
                    ...
                    <span
                      className={`bg-gradient-to-r from-[#D4AF37] via-[#FFD700] to-[#B8860B] bg-clip-text text-transparent animate-gradient sm:ml-3 ${isDarkMode ? "drop-shadow-[0_0_20px_rgba(234,179,8,0.3)]" : ""}`}
                    >
                      LIFESTYLE
                    </span>
                  </span>
                ...
                <div className="flex items-center gap-3 mt-3">
                  ...
                  <p
                    className={`text-base sm:text-lg md:text-xl font-semibold italic tracking-wide ${isDarkMode ? "text-yellow-400/90" : "text-yellow-600"}`}
                  >
              ...
              <p
                className={`text-base sm:text-lg max-w-2xl font-medium ${isDarkMode ? "text-gray-400" : "text-slate-600"}`}
              >
                {viewMode === "retail"
                  ? "Premium luxury toys for families and exclusive collectors"
                  : "High-margin bulk acquisitions for business partners"}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full lg:w-auto">
              ...
              <div
                className={`flex w-full sm:w-auto p-1.5 backdrop-blur-md rounded-xl shadow-2xl border ${
                  isDarkMode
                    ? "bg-neutral-950/80 border-yellow-500/30"
                    : "bg-white/80 border-yellow-400/50"
                }`}
              >
                <button
                  onClick={() => {
                  ...
                  className={`flex-1 sm:flex-none justify-center relative px-4 sm:px-8 py-3 rounded-lg text-sm font-black tracking-widest uppercase transition-all duration-300 flex items-center gap-2 sm:gap-3 ${
                    viewMode === "retail"
                      ...
                      : isDarkMode
                        ...
                        : "text-yellow-700/70 hover:text-yellow-600 hover:bg-black/5"
                  }`}
                >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              >
                <div
                  className={`p-5 sm:p-8 border-b flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${
                    isDarkMode
                      ? "bg-gradient-to-r from-neutral-900/50 to-neutral-950/50 border-yellow-500/20"
                      : "bg-gradient-to-r from-yellow-50 to-white border-yellow-400/30"
                  }`}
                >
                  <div>
                    <div className="flex items-center gap-3 sm:gap-4 mb-2">
                      ...
                      <h2
                        className={`text-xl sm:text-2xl font-black tracking-widest uppercase ${isDarkMode ? "text-white" : "text-slate-900"}`}
                      >
                        {viewMode === "retail"
                          ? "Retail Collection"
                          : "Wholesale Vault"}
                    ...
                    <p
                      className={`text-xs sm:text-sm pl-4 sm:pl-6 font-medium ${isDarkMode ? "text-yellow-500/60" : "text-yellow-700/70"}`}
                    >
                      {viewMode === "retail"
                        ? "Curated selections with exclusive pricing"
                        : "Bulk acquisition catalog with maximum margins"}
                    </p>
                  </div>
                  <div
                    className={`self-start sm:self-auto flex items-center gap-2 px-4 py-2 rounded-full border shadow-inner ${
                      isDarkMode
                  ...
                  >
                    <span
                      className={`text-xs font-black tracking-widest whitespace-nowrap ${isDarkMode ? "text-yellow-400" : "text-yellow-700"}`}
                    >
                ...
                <div className="hidden md:block overflow-x-auto">
                  <table className="w-full min-w-[600px]">
                    <thead
                      className={`border-b ${isDarkMode ? "bg-neutral-900/40 border-yellow-500/20" : "bg-yellow-50/50 border-yellow-200"}`}
                    >
                      <tr>
                        <th
                          className={`text-left p-4 sm:p-5 text-xs font-black uppercase tracking-widest ${isDarkMode ? "text-yellow-600/80" : "text-yellow-700"}`}
                        >
                          Product
                        </th>
                        <th
                        ...
                        >
                          <td className="p-4 sm:p-5">
                            <div className="flex items-center gap-3 sm:gap-4">
                              <div
                                className={`w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0 rounded-xl flex items-center justify-center text-xl sm:text-2xl border shadow-lg group-hover:scale-110 transition-transform ${
                                  isDarkMode
                                    ? "bg-neutral-900 border-yellow-500/20"
                              ...
                              <div>
                                <div
                                  className={`font-bold text-base sm:text-lg tracking-wide ${isDarkMode ? "text-white" : "text-slate-900"}`}
                                >
                                  {product.name}
                                </div>
                                <div className="flex items-center gap-2 sm:gap-3 mt-1 sm:mt-1.5">
                                  <span
                                    className={`text-[10px] px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md font-bold border ${
                                      isDarkMode
                                  ...
                                  <span
                                    className={`text-[10px] sm:text-xs font-medium whitespace-nowrap ${isDarkMode ? "text-gray-500" : "text-slate-500"}`}
                                  >
                                    {viewMode === "retail"
                          ...
                          <td className="p-4 sm:p-5">
                            <span
                              className={`text-[10px] sm:text-xs font-bold tracking-widest uppercase px-2 py-1 sm:px-3 sm:py-1.5 rounded-lg border whitespace-nowrap ${
                                isDarkMode
                                  ? "text-yellow-500/80 bg-neutral-900 border-white/10"
                          ...
                          <td className="p-4 sm:p-5">
                            <div className="flex flex-col">
                              <span
                                className={`font-black text-lg sm:text-xl whitespace-nowrap ${isDarkMode ? "text-yellow-400" : "text-yellow-600"}`}
                              >
                                {product.price}
                              </span>
                              {viewMode === "retail" &&
                                product.originalPrice && (
                                  <span
                                    className={`text-[10px] sm:text-xs line-through font-medium ${isDarkMode ? "text-gray-500" : "text-slate-400"}`}
                                  >
                                    {product.originalPrice}
                                  </span>
                                )}
                          ...
                          {viewMode === "retail" ? (
                            <>
                              <td className="p-4 sm:p-5">
                                <span className="text-sm sm:text-base font-black text-green-500">
                                  {product.discount}
                                </span>
                              </td>
                              <td className="p-4 sm:p-5">
                                <span
                                  className={`text-[10px] sm:text-xs font-bold tracking-widest uppercase whitespace-nowrap ${product.stock === "In Stock" ? (isDarkMode ? "text-yellow-400" : "text-yellow-600") : "text-red-500"}`}
                                >
                                  {product.stock}
                                </span>
                              </td>
                            ...
                            <>
                              <td className="p-4 sm:p-5">
                                <span
                                  className={`text-xs sm:text-sm font-bold px-2 py-1 sm:px-3 sm:py-1 rounded-lg whitespace-nowrap ${isDarkMode ? "text-white bg-neutral-800" : "text-slate-800 bg-slate-100"}`}
                                >
                                  {product.moq}
                                </span>
                              </td>
                  ...
                  {currentProducts.length === 0 && (
                    <div
                      className={`p-10 sm:p-16 text-center font-medium border-t ${isDarkMode ? "text-gray-500 border-white/5" : "text-slate-400 border-slate-100"}`}
                    >
                ...
                <div className="md:hidden p-4 sm:p-6 space-y-3">
                  {currentProducts.map((product, index) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div
                          className={`flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border text-xl ${isDarkMode ? "border-yellow-500/20 bg-neutral-900" : "border-yellow-200 bg-yellow-50"}`}
                        >
                          {product.icon}
                        </div>
                        <div className="min-w-0 flex-1">
                          ...
                          <div
                            className={`mt-1 text-[11px] font-medium ${isDarkMode ? "text-gray-400" : "text-slate-500"}`}
                          >
                            {product.category}
                          </div>
                          <div className="mt-2 flex items-center justify-between gap-3">
                            <span
                              className={`text-sm font-black ${isDarkMode ? "text-yellow-400" : "text-yellow-600"}`}
                            >
                              {product.price}
                            </span>
                            <span
                              className={`rounded-full px-2.5 py-1 text-[10px] font-black uppercase ${isDarkMode ? "bg-yellow-500/10 text-yellow-400" : "bg-yellow-100 text-yellow-700"}`}
                            >
                              {viewMode === "retail"
                                ? product.discount || product.stock
                                : product.moq || product.margin}
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  {currentProducts.length === 0 && (
                    <div
                      className={`rounded-2xl border p-8 text-center text-sm ${isDarkMode ? "border-white/10 bg-neutral-900/70 text-gray-400" : "border-yellow-200 bg-white text-slate-400"}`}
                    >
                      No exclusive products available in this category yet.
                    </div>
                  )}
            ...
            <div className="lg:col-span-1">
              <AnimatePresence mode="wait">
                ...
                >
                  <div
                    className={`rounded-3xl p-6 sm:p-8 h-full border relative overflow-hidden flex flex-col group ${
                      isDarkMode
                  ...
                  >
                    ...
                    ></div>
                    <div
                      className={`absolute bottom-0 left-0 w-32 sm:w-40 h-32 sm:h-40 rounded-full blur-[40px] sm:blur-[60px] ${isDarkMode ? "bg-amber-600/10" : "bg-amber-500/20"}`}
                    ></div>
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                      ...
                      <div className="flex items-center gap-3 mb-6 sm:mb-8">
                        ...
                        <span className="text-[10px] sm:text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.25em] text-yellow-600">
                      ...
                      <div className="mb-8 sm:mb-10 text-center">
                        <div className="relative inline-block">
                          <div
                            className={`text-6xl sm:text-7xl font-black mb-2 leading-none text-transparent bg-clip-text drop-shadow-lg ${
                              isDarkMode
                          ...
                          >
                            ...
                            <span className="text-3xl sm:text-4xl text-yellow-500">
                              %
                            </span>
                          </div>
                        ...
                        <div
                          className={`text-lg sm:text-xl font-black mb-2 sm:mb-3 tracking-widest uppercase mt-4 ${isDarkMode ? "text-white" : "text-slate-900"}`}
                        >
                          {currentOffer.title}
                        </div>
                        <p
                          className={`text-xs sm:text-sm font-medium px-2 sm:px-4 leading-relaxed ${isDarkMode ? "text-gray-400" : "text-slate-600"}`}
                        >
                        ...
                        <div
                          className={`flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-2xl transition-colors border ${
                            isDarkMode
                              ...
                              : "bg-yellow-50/50 border-yellow-100 hover:bg-yellow-100"
                          }`}
                        >
                          <div
                            className={`w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 rounded-xl border flex items-center justify-center ${
                              isDarkMode
                          ...
                          >
                            <CheckCircle
                              className={`w-4 h-4 sm:w-5 sm:h-5 ${isDarkMode ? "text-yellow-500" : "text-yellow-600"}`}
                            />
                          </div>
                          <div>
                            <div
                            ...
                            >
                              {currentOffer.perk1?.title}
                            </div>
                            <div
                              className={`text-[10px] sm:text-xs font-medium mt-0.5 ${isDarkMode ? "text-yellow-500/80" : "text-yellow-700"}`}
                            >
                              {currentOffer.perk1?.desc}
                            </div>
                          </div>
                        </div>
                        <div
                        ...
                        >
                          ...
                          <div>
                            <div
                              className={`font-bold text-xs sm:text-sm ${isDarkMode ? "text-white" : "text-slate-900"}`}
                            >
                              {currentOffer.perk2?.title}
                            </div>
                            <div
                              className={`text-[10px] sm:text-xs font-medium mt-0.5 ${isDarkMode ? "text-yellow-500/80" : "text-yellow-700"}`}
                            >
                              {currentOffer.perk2?.desc}
                            </div>
                          </div>
                        </div>
                        <div
                        ...
                        >
                          ...
                          <div>
                            <div
                              className={`font-bold text-xs sm:text-sm ${isDarkMode ? "text-white" : "text-slate-900"}`}
                            >
                              {currentOffer.perk3?.title}
                            </div>
                            <div
                              className={`text-[10px] sm:text-xs font-medium mt-0.5 ${isDarkMode ? "text-yellow-500/80" : "text-yellow-700"}`}
                            >
                              {currentOffer.perk3?.desc}
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div
                          className={`mt-2 p-4 sm:p-5 rounded-2xl border mb-6 sm:mb-8 ${
                            isDarkMode
                              ...
                              : "bg-gradient-to-br from-yellow-50 to-white border-yellow-300 shadow-inner"
                          }`}
                        >
                          <div
                            className={`text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] mb-2 ${isDarkMode ? "text-yellow-500/80" : "text-yellow-600"}`}
                          >
                            Selected Artifact
                          </div>
                          <div
                            className={`flex items-center justify-between gap-4 ${isDarkMode ? "text-white" : "text-slate-900"}`}
                          >
                            ...
                            <div className="text-right flex-shrink-0">
                              <div
                                className={`text-lg sm:text-xl font-black ${isDarkMode ? "text-yellow-400" : "text-yellow-600"}`}
                              >
                                {currentProducts[selectedProduct].price}
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div
                        className={`text-[9px] sm:text-[10px] text-center mt-3 sm:mt-4 font-medium uppercase tracking-widest ${isDarkMode ? "text-gray-500" : "text-slate-400"}`}
                      >
                        {currentOffer.terms}
                      </div>
                    </div>
