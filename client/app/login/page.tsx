    ...
    <>
      ...
      <div className={`relative z-10 w-full max-w-md overflow-hidden rounded-[2.5rem] bg-gray-900/40 p-8 shadow-2xl backdrop-blur-xl ring-1 ring-white/10 sm:p-10 transition-all duration-500 ${showSuccess ? "scale-95 opacity-50 blur-sm" : "scale-100 opacity-100"}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className={`transition-all duration-300 ease-in-out ${!isLogin ? "max-h-24 opacity-100 mb-2" : "max-h-0 opacity-0 overflow-hidden"}`}>
            <p className="text-xs text-gray-400 mb-2 text-center tracking-wide uppercase">I am registering as</p>
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-full border border-white/10 bg-black/20 px-6 py-4 pr-14 text-sm text-white placeholder-gray-500 focus:border-[#FF0000]/50 focus:bg-black/40 focus:outline-none transition-colors"
            />
            <button
              type="submit"
              disabled={loading}
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          ...
          <button onClick={toggleMode} className="font-medium text-[#FF0000] hover:text-red-400 hover:underline transition-colors">
